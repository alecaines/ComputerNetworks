...
def lookup(target_name: dns.name.Name,
    ...
    #elif ' A ' in target:
    #    A+=str(target)[str(target).find('[')+1:str(target).find(']')].split(',')
    #elif 'AAAA' in target:
    #    AAAA+=str(target)[str(target).find('[')+1:str(target).find(']')].split(',')
    #elif 'MX' in target:
    #    MX+=str(target)[str(target).find('[')+1:str(target).find(']')].split(',')
