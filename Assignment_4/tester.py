"""
Utility script for testing assignment 4 solutions under user set conditions.
"""
import time
import argparse
import subprocess
...
LOGGER = assignment4.logging.get_logger("assignment-4-tester")
if ARGS.verbose:
...
INPUT_LEN, INPUT_HASH = assignment4.utils.file_summary(INPUT_PATH)
...
RECV_LEN, RECV_HASH = assignment4.utils.file_summary(RECV_PATH)
